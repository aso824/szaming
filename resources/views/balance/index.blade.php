        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        @forelse ($balanceViewModel->getCredits() as $creditor)
                            @php /** @var \App\Models\User $creditor */ @endphp

                            @if ($loop->first)
                                  <ul>
                            @endif
                                      <li>
                                          {{ $creditor->name }}: <span class="font-weight-bold text-danger">-{{ $balanceViewModel->formatPrice($creditor->pivot->amount) }}</span>
                                      </li>
                            @if ($loop->last)
                                  </ul>
                            @endif
